...
/**
 * Generate embedding for a user query/message
 * @param {string} message - The user message to embed
 * @returns {Promise<number[]>} - 1536-dimensional embedding vector
 */
export async function generateQueryEmbedding(message) {
  return generateEmbedding(message);
}
