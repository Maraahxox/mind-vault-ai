...
encodeFunctionData(functionFragment: 'hasMinted', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'isApprovedForAll', values: [AddressLike, AddressLike]): string;
encodeFunctionData(functionFragment: 'mintSoulbound', values?: undefined): string;
...
decodeFunctionResult(functionFragment: 'mintSoulbound', data: BytesLike): Result;
...
getFunction(nameOrSignature: 'isApprovedForAll'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'mintSoulbound'): TypedContractMethod<
      [],
      [void],
      'nonpayable'
    >;
