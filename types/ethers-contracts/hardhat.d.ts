...
getContractFactory(name: 'SoulboundNFT', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.SoulboundNFT__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'SoulboundNFT', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.SoulboundNFT>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'SoulboundNFT', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SoulboundNFT>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'SoulboundNFT', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SoulboundNFT>
